...
class Banner:
    def __init__(self, surf, s, font, font2, turret, enemy, boss):
        ...
        self.buttons = [{
                "Health": 
                    {"rect": self.rect([105, 200], self.buttonsize), "var": {"class": self.turret, "name": "maxhealth"}, "effect": 25, "used": 0, "use limit": 5, "money": 300},
                "Damage": 
                    {"rect": self.rect([165, 200], self.buttonsize), "var": {"class": self.turret, "name": "damage"}, "effect": 25,"used": 0, "use limit": 5, "money": 200},
                "R Factor": 
                    {"rect": self.rect([225, 200], self.buttonsize), "var": {"class": self.turret, "name": "regen_factor"}, "effect": 5, "used": 0, "use limit": 5, "money": 500},
                "R Rate": 
                    {"rect": self.rect([285, 200], self.buttonsize), "var": {"class": self.turret, "name": "regen_rate"}, "effect": 1, "used": 0, "use limit": 4, "money": 500}
            }, {
                "Speed": 
                    {"rect": self.rect([105, 260], self.buttonsize), "var": {"class": self.turret, "name": "bullet_speed"}, "effect": 2, "used": 0, "use limit": 5, "money": 100},
                "Size": 
                    {"rect": self.rect([165, 260], self.buttonsize), "var": {"class": self.turret, "name": "bullet_size"}, "effect":  2, "used": 0, "use limit": 5, "money" :500},
                "Rounds": 
                    {"rect": self.rect([225, 260], self.buttonsize), "var": {"class": self.turret, "name": "round_size"}, "effect": 5, "used": 0, "use limit": 5, "money": 500}
            }, {
                "Size":
                    {"rect": self.rect([105, 320], self.buttonsize), "var": {"class": self.enemy, "name": "size"}, "effect": 4, "used": 0, "use limit": 5, "money": 100},
                "Speed":
                    {"rect": self.rect([165, 320], self.buttonsize), "var": {"class": self.enemy, "name": "speed"}, "effect": -0.25, "used": 0, "use limit": 5,"money": 300},
                "Health":   
                    {"rect": self.rect([225, 320], self.buttonsize), "var": {"class": self.enemy, "name": "basehealth"}, "effect": -10, "used": 0, "use limit": 5,"money": 200},
                "Spawn":
                    {"rect": self.rect([285, 320], self.buttonsize), "var": {"class": self.enemy, "name": "spawnrate"}, "effect": 1, "used": 0, "use limit": 5,"money": 300}
            }, {
                "Size":
                    {"rect": self.rect([105, 380], self.buttonsize), "var": {"class": self.boss, "name": "size"}, "effect": 20, "used": 0, "use limit": 5, "money": 200},
                "Speed":
                    {"rect": self.rect([165, 380], self.buttonsize), "var": {"class": self.boss, "name": "speed"}, "effect": -0.1, "used": 0, "use limit": 5, "money": 400},
                "Health":
                    {"rect": self.rect([225, 380], self.buttonsize), "var": {"class": self.boss, "name": "basehealth"}, "effect": -50, "used": 0, "use limit": 5, "money": 300}
            }, {
                "Mags": 
                    {"rect": self.rect([105, 440], self.buttonsize), "var": {"class": self.turret, "name": "magasines"}, "effect": 1, "used": 0, "use limit": math.inf, "money": 100},
                "Profit":
                    {"rect": self.rect([165, 440], self.buttonsize), "var": {"class": self.turret, "name": "profit"}, "effect": 10, "used": 0, "use limit": 5, "money": 500},
                "Regen":
                    {"rect": self.rect([225, 440], self.buttonsize), "var": {"class": self.turret, "name": "health"}, "effect": 500, "used": 0, "use limit": math.inf, "money": 500}
            }]
    ...
    def update_graphics(self):
        ...
        # Headers
        for p, i in enumerate([self.font2.render("FPS: %s" % str(self.fps)[:6], True, (0, 0, 0)),\
                               self.font2.render("Kills: %d" % self.turret.kills, True, (0, 0, 0)),\ 
                               self.font2.render("Score: %d" % self.turret.score, True, (0, 0, 0)),\ 
                               self.font2.render("Money: %d" % self.turret.money, True, (0, 0, 0)),\ 
                               self.font.render("Turret Health: %d/%d" % (self.turret.health, self.turret.maxhealth), True, (0, 0, 0))]):
            self.banner.blit(i, i.get_rect(center=\
                 [[self.banner_res[0]/4, self.banner_res[1]/20],\
                  [self.banner_res[0]/4, self.banner_res[1]*0.14],\
                  [self.banner_res[0]*0.75, self.banner_res[1]/20],\
                  [self.banner_res[0]*0.75, self.banner_res[1]*0.14],\
                  [self.banner_res[0]/2, self.banner_res[1]/5]][p]))
        ...
        for p, i in enumerate([
            self.font.render("Player:", True, (0, 0, 0)),\
            self.font.render("Bullets:", True, (255, 200, 0)),\ 
            self.font.render("Enemies:", True, (255, 0, 0)),\ 
            self.font.render("Bosses:", True, (0, 0, 255)),\ 
            self.font.render("Supplies:", True, (0, 255, 0))]):
